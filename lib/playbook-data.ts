      ...
      partners: [{
        ...
        tips: [
          ...
          tipB("Activate your existing customers before the rush", [
            ...
            TARGET("run this on the 'Potential Loyalists' segment and customers who 'Need Attention', buyers who already hold points but have gone quiet. They have a balance and a reason to act, they just lack the urgency, which the expiry deadline supplies."),
          ...
          tipB("Reward loyalty with early access and a members-only offer", [
            ...
            TARGET("point this at your 'Champions' and/or 'Can't Lose Them' segments, your highest-value and longest-history buyers. Exclusivity only lands with people who already feel invested in the brand."),
          ...
          tipB("Use double points as perceived value, not discount", [
            ...
            TARGET("aim this at 'Potential Loyalists' and/or 'Promising buyers' segments, your active customers who are not yet VIP. These are the ones you want to move up the value ladder without a discount."),
          ...
          tipB("Amplify your reach with social engagement missions", [
            ...
            TARGET("the whole base by default, since reach is the point here. With Loyoly you can go finer and single out customers with real social pull, for example nano and micro-influencers above a follower threshold, or members with a high social engagement rate."),
          ...
          tipB("Reactivate at-risk customers with a high-margin discount and a gift", [
            ...
            TARGET("run this on customers slipping away, your 'At Risk' and/or 'Can't Lose Them' segment. Their recency is fading, but their history is rich enough to make winning them back worth the effort."),
          ...
          tipB("Convert the BFCM cohort into a second order", [
            ...
            TARGET("run this on your 'New Customers' segment, high recency but low frequency. With a fresh cohort, the whole job is turning order one into order two."),
          ...
          tipB("Keep November's new customers hooked", [
            ...
            TARGET("run this on the 'New Customers' and/or 'Promising buyers' you picked up at the peak. December is when you decide whether the BFCM spike becomes a lasting base."),
