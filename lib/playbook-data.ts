      ...
      partners: [{
        ...
        tips: [
          tipB("Get your payment methods right for the season", [
            ...
            PB("**What you should do:** enable payment methods 2 months in advance. It costs you nothing, and doing it in advance means the full lifecycle has already run through your system, so when traffic hits, you know it works."),
            PB("**Result:** you capture sales you'd otherwise lose, protect your average order value, and go into peak with a payment mix built for the season."),
          ]),
          tipB("Make mobile and wallets effortless", [
            ...
            PB("**What you should do:** test your mobile checkout before peak, remove unnecessary fields and taps, and make sure wallets, saved details, guest checkout, and fallback options work smoothly."),
            PB("**Result:** you meet shoppers where they already are, on mobile, and remove the friction that quietly costs you sales."),
          ]),
          tipB("Reduce friction for your most loyal customers", [
            ...
            PB("**What you should do:** refresh your list. Make sure every high-value, frequent customer is on it, and that it's fully up to date."),
            PB("**Result:** your best customers glide through checkout, feel valued at your busiest time, and keep coming back long after the promotional period ends."),
          ]),
          tipB("Tell your PSP if you're doing something exceptional", [
            ...
            PB("**What you should do:** if this is the year you launch a limited-edition drop or go unusually hard on a flash sale during the peak season, then tell your PSP."),
            PB("**Result:** your big moment goes off without a hitch, with no legitimate sales blocked at the crucial moment."),
          ]),
          tipB("Nail the post-payment experience", [
            ...
            PB("**What you should do:** make sure your customer communications are clear and easy to follow."),
            PB("**Result:** you reassure anxious gift-buyers, cut support costs, and turn a stressful season into a reason to trust you again next year."),
          ]),
          tipB("Let Mollie optimise your payments in the background", [
            ...
            PB("**Result:** you get stronger payments performance throughout peak, because Mollie is optimising in the background for you."),
          ]),
        ],
      }],
    },
      ...
      partners: [{
        ...
        tips: [
          tipB("Elige bien tus métodos de pago para la temporada", [
            ...
            PB("**Lo que debes hacer:** activa los métodos de pago con dos meses de antelación. No te cuesta nada, y hacerlo con antelación significa que todo el ciclo de vida ya ha pasado por tu sistema, así que cuando aumente el tráfico, sabrás que funciona."),
            PB("**Resultado:** captas ventas que, de otro modo, perderías, proteges el valor medio de tus pedidos y llegas a la temporada alta con una combinación de pagos adaptada a la temporada."),
          ]),
          tipB("Haz que el pago desde el móvil y con monederos electrónicos sea sencillo", [
            ...
            PB("**Lo que debes hacer:** prueba tu proceso de pago en móvil antes de la temporada alta, elimina campos y pasos innecesarios, y asegúrate de que los monederos electrónicos, los datos guardados, el pago como invitado y las opciones alternativas funcionen a la perfección."),
            PB("**Resultado:** te acercas a los compradores allí donde ya están, en el móvil, y eliminas las fricciones que, sin que te des cuenta, te están costando ventas."),
          ]),
          tipB("Reduce las fricciones para tus clientes más fieles", [
            ...
            PB("**Lo que deberías hacer:** actualiza tu lista. Asegúrate de que todos los clientes habituales y de alto valor estén en ella, y de que esté totalmente al día."),
            PB("**Resultado:** tus mejores clientes pasan por caja sin problemas, se sienten valorados en tu momento de mayor actividad y siguen volviendo mucho después de que termine el periodo promocional."),
          ]),
          tipB("Avisa a tu PSP si vas a hacer algo excepcional", [
            ...
            PB("**Lo que debes hacer:** si este es el año en el que vas a lanzar una edición limitada o vas a apostar fuerte por una venta relámpago durante la temporada alta, avisa a tu PSP."),
            PB("**Resultado:** tu gran momento saldrá a la perfección, sin que se bloqueen ventas legítimas en el momento crucial."),
          ]),
          tipB("Perfecciona la experiencia tras el pago", [
            ...
            PB("**Lo que debes hacer:** asegúrate de que tus comunicaciones con los clientes sean claras y fáciles de seguir."),
            PB("**Resultado:** tranquilizas a los compradores de regalos nerviosos, reduces los costes de atención al cliente y conviertes una temporada estresante en un motivo para que vuelvan a confiar en ti el año que viene."),
          ]),
          tipB("Deja que Mollie optimice tus pagos en segundo plano", [
            ...
            PB("**Resultado:** consigues un mejor rendimiento de los pagos durante los picos de actividad, porque Mollie se encarga de optimizarlo todo en segundo plano por ti."),
          ]),
        ],
      }],
    },
