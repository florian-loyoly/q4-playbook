      ...
      partners: [{
        ...
        tips: [
          tipB("Calibrate your program before November", [
            ...
            EX("Example", "if your average time between orders is 6 months, expire rewards after 3 to 4 months. You create urgency ahead of the natural repurchase cycle, so the reward drives a purchase instead of waiting for one."),
